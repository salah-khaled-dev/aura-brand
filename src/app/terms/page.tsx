...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <LegalParagraph>
        باستخدامكِ لموقع دار أورا للأزياء الراقية (aura-brand-virid.vercel.app) أو إجرائكِ لأي عملية شراء، فإنكِ توافقين على الالتزام بهذه الشروط والأحكام كاملةً. إذا كنتِ لا توافقين على أي بند من هذه البنود، يُرجى الامتناع عن استخدام الموقع.
      </LegalParagraph>
      <LegalParagraph>
